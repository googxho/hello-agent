...
#
# 检索模式：semantic（默认，向量）/ keyword（v5 的字面匹配）。
# 想亲手对比两者？把它们并排跑一遍就知道差别了：
#
#     LLM_RETRIEVAL_MODE=keyword python main.py
#
RETRIEVAL_MODE = (os.getenv("LLM_RETRIEVAL_MODE") or "semantic").strip().lower()
...
CONFIG_KEYS: list[tuple[str, str, str]] = [
    ...
    ("LLM_RETRIEVAL_MODE", RETRIEVAL_MODE, "v6 新增"),
